                ...
                <Col className="pt-5 mt-0">
                                            ...
                                            <div>
                                                <div className="mc-field-group">
                                                    <InputGroup className="pt-3">
                                                        ...
                                                        <Button as="input" type="submit" id="mc-embedded-subscribe" variant="dark">Subscribe</Button>
                                                    </InputGroup>
                                                </div>
                                            </div>
                    ...
                    <Col className="d-flex justify-content-between py-1 mt-1">
                        ...
                        <ul className="list-unstyled d-flex">
                            ...
                            <li className="ms-3">
                                <a href="https://twitter.com/JosVBeluskoCo" target="_blank">
                            ...
                            <li className="ms-3">
                                <a href="https://www.linkedin.com/in/brian-french-82633290/" target="_blank">
